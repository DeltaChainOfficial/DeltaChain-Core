...
// source: DeltaChain/store/types.proto
...
func init() {
	proto.RegisterType((*BlockStoreState)(nil), "DeltaChain.store.BlockStoreState")
}

func init() { proto.RegisterFile("DeltaChain/store/types.proto", fileDescriptor_ff9e53a0a74267f7) }
