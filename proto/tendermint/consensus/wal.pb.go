...
// source: DeltaChain/consensus/wal.proto
...
func init() {
	proto.RegisterType((*MsgInfo)(nil), "DeltaChain.consensus.MsgInfo")
	proto.RegisterType((*TimeoutInfo)(nil), "DeltaChain.consensus.TimeoutInfo")
	proto.RegisterType((*EndHeight)(nil), "DeltaChain.consensus.EndHeight")
	proto.RegisterType((*WALMessage)(nil), "DeltaChain.consensus.WALMessage")
	proto.RegisterType((*TimedWALMessage)(nil), "DeltaChain.consensus.TimedWALMessage")
}

func init() { proto.RegisterFile("DeltaChain/consensus/wal.proto", fileDescriptor_ed0b60c2d348ab09) }
