...
// source: DeltaChain/consensus/types.proto
...
import (
	...
	bits "github.com/DeltaChain/DeltaChain/proto/DeltaChain/libs/bits"
...
type HasVote struct {
	Height int64               `protobuf:"varint,1,opt,name=height,proto3" json:"height,omitempty"`
	Round  int32               `protobuf:"varint,2,opt,name=round,proto3" json:"round,omitempty"`
	Type   types.SignedMsgType `protobuf:"varint,3,opt,name=type,proto3,enum=DeltaChain.types.SignedMsgType" json:"type,omitempty"`
...
func init() {
	proto.RegisterType((*NewRoundStep)(nil), "DeltaChain.consensus.NewRoundStep")
	proto.RegisterType((*NewValidBlock)(nil), "DeltaChain.consensus.NewValidBlock")
	proto.RegisterType((*Proposal)(nil), "DeltaChain.consensus.Proposal")
	proto.RegisterType((*ProposalPOL)(nil), "DeltaChain.consensus.ProposalPOL")
	proto.RegisterType((*BlockPart)(nil), "DeltaChain.consensus.BlockPart")
	proto.RegisterType((*Vote)(nil), "DeltaChain.consensus.Vote")
	proto.RegisterType((*HasVote)(nil), "DeltaChain.consensus.HasVote")
	proto.RegisterType((*VoteSetMaj23)(nil), "DeltaChain.consensus.VoteSetMaj23")
	proto.RegisterType((*VoteSetBits)(nil), "DeltaChain.consensus.VoteSetBits")
	proto.RegisterType((*Message)(nil), "DeltaChain.consensus.Message")
}

func init() { proto.RegisterFile("DeltaChain/consensus/types.proto", fileDescriptor_81a22d2efc008981) }
