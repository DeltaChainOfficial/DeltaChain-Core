...
// source: DeltaChain/version/types.proto
...
func init() {
	proto.RegisterType((*App)(nil), "DeltaChain.version.App")
	proto.RegisterType((*Consensus)(nil), "DeltaChain.version.Consensus")
}

func init() { proto.RegisterFile("DeltaChain/version/types.proto", fileDescriptor_f9b42966edc5edad) }
