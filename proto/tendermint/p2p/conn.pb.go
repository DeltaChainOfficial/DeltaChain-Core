...
// source: DeltaChain/p2p/conn.proto
...
func init() {
	proto.RegisterType((*PacketPing)(nil), "DeltaChain.p2p.PacketPing")
	proto.RegisterType((*PacketPong)(nil), "DeltaChain.p2p.PacketPong")
	proto.RegisterType((*PacketMsg)(nil), "DeltaChain.p2p.PacketMsg")
	proto.RegisterType((*Packet)(nil), "DeltaChain.p2p.Packet")
	proto.RegisterType((*AuthSigMessage)(nil), "DeltaChain.p2p.AuthSigMessage")
}

func init() { proto.RegisterFile("DeltaChain/p2p/conn.proto", fileDescriptor_22474b5527c8fa9f) }
