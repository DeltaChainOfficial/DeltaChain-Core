...
// source: DeltaChain/p2p/pex.proto
...
func init() {
	proto.RegisterType((*PexRequest)(nil), "DeltaChain.p2p.PexRequest")
	proto.RegisterType((*PexAddrs)(nil), "DeltaChain.p2p.PexAddrs")
	proto.RegisterType((*Message)(nil), "DeltaChain.p2p.Message")
}

func init() { proto.RegisterFile("DeltaChain/p2p/pex.proto", fileDescriptor_81c2f011fd13be57) }
