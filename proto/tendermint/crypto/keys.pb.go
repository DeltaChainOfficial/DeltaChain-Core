...
// source: DeltaChain/crypto/keys.proto
...
func init() {
	proto.RegisterType((*PublicKey)(nil), "DeltaChain.crypto.PublicKey")
}

func init() { proto.RegisterFile("DeltaChain/crypto/keys.proto", fileDescriptor_cb048658b234868c) }
