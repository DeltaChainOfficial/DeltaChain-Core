...
// source: DeltaChain/crypto/proof.proto
...
func init() {
	proto.RegisterType((*Proof)(nil), "DeltaChain.crypto.Proof")
	proto.RegisterType((*ValueOp)(nil), "DeltaChain.crypto.ValueOp")
	proto.RegisterType((*DominoOp)(nil), "DeltaChain.crypto.DominoOp")
	proto.RegisterType((*ProofOp)(nil), "DeltaChain.crypto.ProofOp")
	proto.RegisterType((*ProofOps)(nil), "DeltaChain.crypto.ProofOps")
}

func init() { proto.RegisterFile("DeltaChain/crypto/proof.proto", fileDescriptor_6b60b6ba2ab5b856) }
