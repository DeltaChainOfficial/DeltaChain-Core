...
// source: DeltaChain/libs/bits/types.proto
...
func init() {
	proto.RegisterType((*BitArray)(nil), "DeltaChain.libs.bits.BitArray")
}

func init() { proto.RegisterFile("DeltaChain/libs/bits/types.proto", fileDescriptor_e91ab2672920d7d4) }
