...
// source: DeltaChain/types/canonical.proto
...
func init() {
	proto.RegisterType((*CanonicalBlockID)(nil), "DeltaChain.types.CanonicalBlockID")
	proto.RegisterType((*CanonicalPartSetHeader)(nil), "DeltaChain.types.CanonicalPartSetHeader")
	proto.RegisterType((*CanonicalProposal)(nil), "DeltaChain.types.CanonicalProposal")
	proto.RegisterType((*CanonicalVote)(nil), "DeltaChain.types.CanonicalVote")
}

func init() { proto.RegisterFile("DeltaChain/types/canonical.proto", fileDescriptor_8d1a1a84ff7267ed) }
