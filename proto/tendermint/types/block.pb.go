...
// source: DeltaChain/types/block.proto
...
func init() {
	proto.RegisterType((*Block)(nil), "DeltaChain.types.Block")
}

func init() { proto.RegisterFile("DeltaChain/types/block.proto", fileDescriptor_70840e82f4357ab1) }
