...
// source: DeltaChain/types/events.proto
...
func init() {
	proto.RegisterType((*EventDataRoundState)(nil), "DeltaChain.types.EventDataRoundState")
}

func init() { proto.RegisterFile("DeltaChain/types/events.proto", fileDescriptor_72cfafd446dedf7c) }
