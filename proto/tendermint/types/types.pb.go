...
// source: DeltaChain/types/types.proto
...
import (
	...
	version "github.com/DeltaChain/DeltaChain/proto/DeltaChain/version"
	io "io"
	math "math"
	math_bits "math/bits"
	time "time"
...
// consensus.
type Vote struct {
	Type             SignedMsgType `protobuf:"varint,1,opt,name=type,proto3,enum=DeltaChain.types.SignedMsgType" json:"type,omitempty"`
...
type CommitSig struct {
	BlockIdFlag      BlockIDFlag `protobuf:"varint,1,opt,name=block_id_flag,json=blockIdFlag,proto3,enum=DeltaChain.types.BlockIDFlag" json:"block_id_flag,omitempty"`
...
func init() {
	proto.RegisterEnum("DeltaChain.types.BlockIDFlag", BlockIDFlag_name, BlockIDFlag_value)
	proto.RegisterEnum("DeltaChain.types.SignedMsgType", SignedMsgType_name, SignedMsgType_value)
	proto.RegisterType((*PartSetHeader)(nil), "DeltaChain.types.PartSetHeader")
	proto.RegisterType((*Part)(nil), "DeltaChain.types.Part")
	proto.RegisterType((*BlockID)(nil), "DeltaChain.types.BlockID")
	proto.RegisterType((*Header)(nil), "DeltaChain.types.Header")
	proto.RegisterType((*Data)(nil), "DeltaChain.types.Data")
	proto.RegisterType((*Vote)(nil), "DeltaChain.types.Vote")
	proto.RegisterType((*Commit)(nil), "DeltaChain.types.Commit")
	proto.RegisterType((*CommitSig)(nil), "DeltaChain.types.CommitSig")
	proto.RegisterType((*Proposal)(nil), "DeltaChain.types.Proposal")
	proto.RegisterType((*SignedHeader)(nil), "DeltaChain.types.SignedHeader")
	proto.RegisterType((*LightBlock)(nil), "DeltaChain.types.LightBlock")
	proto.RegisterType((*BlockMeta)(nil), "DeltaChain.types.BlockMeta")
	proto.RegisterType((*TxProof)(nil), "DeltaChain.types.TxProof")
}

func init() { proto.RegisterFile("DeltaChain/types/types.proto", fileDescriptor_d3a6e55e2345de56) }
