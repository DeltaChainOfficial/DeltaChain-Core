...
// source: DeltaChain/types/validator.proto
...
func init() {
	proto.RegisterType((*ValidatorSet)(nil), "DeltaChain.types.ValidatorSet")
	proto.RegisterType((*Validator)(nil), "DeltaChain.types.Validator")
	proto.RegisterType((*SimpleValidator)(nil), "DeltaChain.types.SimpleValidator")
}

func init() { proto.RegisterFile("DeltaChain/types/validator.proto", fileDescriptor_4e92274df03d3088) }
