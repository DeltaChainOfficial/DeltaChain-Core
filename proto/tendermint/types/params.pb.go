...
// source: DeltaChain/types/params.proto
...
func init() {
	proto.RegisterType((*ConsensusParams)(nil), "DeltaChain.types.ConsensusParams")
	proto.RegisterType((*BlockParams)(nil), "DeltaChain.types.BlockParams")
	proto.RegisterType((*EvidenceParams)(nil), "DeltaChain.types.EvidenceParams")
	proto.RegisterType((*ValidatorParams)(nil), "DeltaChain.types.ValidatorParams")
	proto.RegisterType((*VersionParams)(nil), "DeltaChain.types.VersionParams")
	proto.RegisterType((*HashedParams)(nil), "DeltaChain.types.HashedParams")
}

func init() { proto.RegisterFile("DeltaChain/types/params.proto", fileDescriptor_e12598271a686f57) }
