...
// source: DeltaChain/blockchain/types.proto
...
func init() {
	proto.RegisterType((*BlockRequest)(nil), "DeltaChain.blockchain.BlockRequest")
	proto.RegisterType((*NoBlockResponse)(nil), "DeltaChain.blockchain.NoBlockResponse")
	proto.RegisterType((*BlockResponse)(nil), "DeltaChain.blockchain.BlockResponse")
	proto.RegisterType((*StatusRequest)(nil), "DeltaChain.blockchain.StatusRequest")
	proto.RegisterType((*StatusResponse)(nil), "DeltaChain.blockchain.StatusResponse")
	proto.RegisterType((*Message)(nil), "DeltaChain.blockchain.Message")
}

func init() { proto.RegisterFile("DeltaChain/blockchain/types.proto", fileDescriptor_2927480384e78499) }
