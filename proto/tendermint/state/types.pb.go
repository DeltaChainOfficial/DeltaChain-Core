...
// source: DeltaChain/state/types.proto
...
func init() {
	proto.RegisterType((*ABCIResponses)(nil), "DeltaChain.state.ABCIResponses")
	proto.RegisterType((*ValidatorsInfo)(nil), "DeltaChain.state.ValidatorsInfo")
	proto.RegisterType((*ConsensusParamsInfo)(nil), "DeltaChain.state.ConsensusParamsInfo")
	proto.RegisterType((*ABCIResponsesInfo)(nil), "DeltaChain.state.ABCIResponsesInfo")
	proto.RegisterType((*Version)(nil), "DeltaChain.state.Version")
	proto.RegisterType((*State)(nil), "DeltaChain.state.State")
}

func init() { proto.RegisterFile("DeltaChain/state/types.proto", fileDescriptor_ccfacf933f22bf93) }
