...
// source: DeltaChain/mempool/types.proto
...
func init() {
	proto.RegisterType((*Txs)(nil), "DeltaChain.mempool.Txs")
	proto.RegisterType((*Message)(nil), "DeltaChain.mempool.Message")
}

func init() { proto.RegisterFile("DeltaChain/mempool/types.proto", fileDescriptor_2af51926fdbcbc05) }
