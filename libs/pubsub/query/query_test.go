...
import (
	...
	"github.com/DeltaChain/DeltaChain/libs/pubsub/query"
)
...
func TestMatches(t *testing.T) {
	...
	testCases := []struct {
		...
		{"slash EXISTS",
			map[string][]string{"transfer.recipient": {"DeltaChain1gu6y2a0ffteesyeyeesk23082c6998xyzmt9mz"},
				"transfer.sender": {"DeltaChain1crje20aj4gxdtyct7z3knxqry2jqt2fuaey6u5"}},
			false,
			false,
			false,
		},
