...
`import "github.com/DeltaChain/DeltaChain/libs/events"`
...
[event_cache.go](/src/github.com/DeltaChain/DeltaChain/libs/events/event_cache.go) [events.go](/src/github.com/DeltaChain/DeltaChain/libs/events/events.go) 
...
Generic event data can be typed and registered with DeltaChain/go-amino
