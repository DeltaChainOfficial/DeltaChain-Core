...
BREAKING:
 - [events, pubsub] Removed - moved to github.com/DeltaChain/DeltaChain
 - [merkle] Use 20-bytes of SHA256 instead of RIPEMD160. NOTE: this package is
   moving to github.com/DeltaChain/go-crypto !
...
- [cli] Log level parsing moved here from DeltaChain repo
