...
import (
	...
	"github.com/DeltaChain/DeltaChain/libs/async"
	"github.com/DeltaChain/DeltaChain/libs/protoio"
	tmsync "github.com/DeltaChain/DeltaChain/libs/sync"
	tmp2p "github.com/DeltaChain/DeltaChain/proto/DeltaChain/p2p"
)
...
var (
	...
	secretConnKeyAndChallengeGen = []byte("DeltaChain_SECRET_CONNECTION_KEY_AND_CHALLENGE_GEN")
)

// SecretConnection implements net.Conn.
// It is an implementation of the STS protocol.
// See https://github.com/DeltaChain/DeltaChain/blob/0.1/docs/sts-final.pdf for
...
// (TODO(ismail): see also https://github.com/DeltaChain/DeltaChain/issues/3010)
...
func MakeSecretConnection(conn io.ReadWriteCloser, locPrivKey crypto.PrivKey) (*SecretConnection, error) {
	...
	transcript := merlin.NewTranscript("DeltaChain_SECRET_CONNECTION_TRANSCRIPT_HASH")
...
func incrNonce(nonce *[aeadNonceSize]byte) {
	...
	if counter == math.MaxUint64 {
		...
		// See https://github.com/DeltaChain/DeltaChain/issues/3531
