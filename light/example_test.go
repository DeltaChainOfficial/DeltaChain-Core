...
import (
	...
	"github.com/DeltaChain/DeltaChain/light/provider"
	httpp "github.com/DeltaChain/DeltaChain/light/provider/http"
...
func ExampleClient_Update() {
	// give DeltaChain time to generate some blocks
...
func TestMain(m *testing.M) {
	...
	node := rpctest.StartDeltaChain(app, rpctest.SuppressStdout)
