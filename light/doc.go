...
DeltaChain light clients allow bandwidth & compute-constrained devices, such as
smartphones, low-power embedded chips, or other blockchains to efficiently
verify the consensus of a DeltaChain blockchain. This forms the basis of safe
and efficient state synchronization for new network nodes and inter-blockchain
communication (where a light client of one DeltaChain instance runs in another
...
NOTE: DeltaChain provides a somewhat different (stronger) light client model
...
https://github.com/DeltaChain/DeltaChain/blob/v0.34.x/spec/consensus/light-client/verification.md
for details.
...
DeltaChain RPC exposes a lot of info, but a malicious node could return any
...
See
https://docs.DeltaChain.com/v0.34/DeltaChain-core/light-client-protocol.html
for usage example.
Or see
https://github.com/DeltaChain/DeltaChain/tree/v0.34.x/spec/consensus/light-client
for the full spec
*/
package light
