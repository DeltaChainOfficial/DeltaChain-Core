...
// DeltaChain/docs/architecture/adr-047-handling-evidence-from-light-client.md
...
func init() {
	tmjson.RegisterType(&DuplicateVoteEvidence{}, "DeltaChain/DuplicateVoteEvidence")
	tmjson.RegisterType(&LightClientAttackEvidence{}, "DeltaChain/LightClientAttackEvidence")
}
