...
func (h *Handshaker) Handshake(proxyApp proxy.AppConns) error {
	...
	h.logger.Info("Completed ABCI Handshake - DeltaChain and App are synced",
...
func (h *Handshaker) ReplayBlocks(
	...
	case storeBlockHeight < stateBlockHeight:
		// the state should never be ahead of the store (this is under DeltaChain's control)
	...
	case storeBlockHeight > stateBlockHeight+1:
		// store should be at most one ahead of the state (this is under DeltaChain's control)
	...
	if storeBlockHeight == stateBlockHeight {
		// DeltaChain ran Commit and saved the state.
...
Did you reset DeltaChain without resetting your application's data?`,
