...
A byzantine node used to test DeltaChain consensus against a plethora of different faulty misbehaviors. Designed to easily create new faulty misbehaviors to examine how a DeltaChain network reacts to the misbehavior. Can also be used for fuzzy testing with different network arrangements.
...
The maverick node takes most of the functionality from the existing DeltaChain CLI. To install this, in the directory of this readme, run:
