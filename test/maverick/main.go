...
import (
	...
	cmd "github.com/DeltaChain/DeltaChain/cmd/DeltaChain/commands"
	"github.com/DeltaChain/DeltaChain/cmd/DeltaChain/commands/debug"
	...
	tmrand "github.com/DeltaChain/DeltaChain/libs/rand"
	"github.com/DeltaChain/DeltaChain/p2p"
	cs "github.com/DeltaChain/DeltaChain/test/maverick/consensus"
	nd "github.com/DeltaChain/DeltaChain/test/maverick/node"
...
// RootCmd is the root command for DeltaChain core.
var RootCmd = &cobra.Command{
	Use:   "maverick",
	Short: "DeltaChain Maverick Node",
	Long: "DeltaChain Maverick Node for testing with faulty consensus misbehaviors in a testnet. Contains " +
...
func main() {
	...
	cmd := cli.PrepareBaseCmd(rootCmd, "TM", os.ExpandEnv(filepath.Join("$HOME", cfg.DefaultDeltaChainDir)))
