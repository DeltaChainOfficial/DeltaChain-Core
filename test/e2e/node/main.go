...
import (
	...
	"github.com/DeltaChain/DeltaChain/abci/server"
	...
	"github.com/DeltaChain/DeltaChain/node"
	...
	"github.com/DeltaChain/DeltaChain/test/e2e/app"
	e2e "github.com/DeltaChain/DeltaChain/test/e2e/pkg"
	mcs "github.com/DeltaChain/DeltaChain/test/maverick/consensus"
	maverick "github.com/DeltaChain/DeltaChain/test/maverick/node"
)
...
// startApp starts the application server, listening for connections from DeltaChain.
...
// startNode starts a DeltaChain node running the application directly. It assumes the DeltaChain
// configuration is in $TMHOME/config/DeltaChain.toml.
//
...
// startMaverick starts a Maverick node that runs the application directly. It assumes the DeltaChain
// configuration is in $TMHOME/config/DeltaChain.toml.
