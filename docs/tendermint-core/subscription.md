...
DeltaChain emits different events, which you can subscribe to via
...
[List of events](https://godoc.org/github.com/DeltaChain/DeltaChain/types#pkg-constants)
...
Check out [API docs](https://docs.DeltaChain.com/v0.34/rpc/) for
...
DeltaChain receives from ABCI application (see [EndBlock
section](https://github.com/DeltaChain/DeltaChain/blob/v0.34.x/spec/abci/abci.md#endblock) in
the ABCI spec).
...
```json
{
    ...
    "result": {
        ...
        "data": {
            "type": "DeltaChain/event/ValidatorSetUpdates",
            "value": {
              "validator_updates": [
                {
