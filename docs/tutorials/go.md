...
DeltaChain Core. [DeltaChain SDK](https://github.com/DeltaChain/DeltaChain-sdk) is written
this way. Please refer to [Writing a built-in DeltaChain Core application in
...
import (
	...
	abciserver "github.com/DeltaChain/DeltaChain/abci/server"
...
it upon receiving SIGTERM or Ctrl-C. DeltaChain Core will act as a client,
...
```bash
TMHOME="/tmp/example" DeltaChain node --proxy_app=unix://example.sock
