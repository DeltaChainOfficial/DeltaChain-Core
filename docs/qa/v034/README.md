...
order: 1
parent:
  title: DeltaChain Quality Assurance Results for v0.34.x
...
and processed by DeltaChain, during the 90 seconds of the experiment's duration.
...
Our interpretation for this is that contention within DeltaChain was propagated,
...
that the transactions were able to be processed by the DeltaChain network at least as quickly as they
...
N.B.: The version of DeltaChain used for these tests is affected by #9539.
