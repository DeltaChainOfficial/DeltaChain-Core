...
The documentation for DeltaChain Core is hosted at:
...
[DeltaChain.json](https://github.com/algolia/docsearch-configs/blob/master/configs/DeltaChain.json)
...
[counterpart in the DeltaChain SDK
repo](https://github.com/DeltaChain/DeltaChain-sdk/blob/master/docs/DOCS_README.md).
