...
[protobuf file](https://github.com/DeltaChain/DeltaChain/blob/v0.34.x/proto/DeltaChain/abci/types.proto).
...
server in that language. DeltaChain supports three implementations of the ABCI, written in Go:

- In-process ([Golang](https://github.com/DeltaChain/DeltaChain/tree/v0.34.x/abci), [Rust](https://github.com/DeltaChain/rust-abci))
- ABCI-socket
- GRPC
...
[Go](https://github.com/DeltaChain/DeltaChain/tree/v0.34.x/abci/server),
[JavaScript](https://github.com/DeltaChain/js-abci),
[C++](https://github.com/mdyring/cpp-tmsp), and
[Java](https://github.com/jDeltaChain/jabci).

### In Process

The simplest implementation uses function calls within Golang.
This means ABCI applications written in Golang can be compiled with DeltaChain Core and run as a single binary.
...
DeltaChain Socket Protocol is an asynchronous, raw socket server which provides ordered message passing over unix or tcp.
Messages are serialized using Protobuf3 and length-prefixed with a [signed Varint](https://developers.google.com/protocol-buffers/docs/encoding?csw=1#signed-integers)

If GRPC is not available in your language, or you require higher
performance, or otherwise enjoy programming, you may implement your own
ABCI server using the DeltaChain Socket Protocol. The first step is still to auto-generate the relevant data
...
DeltaChain uses four connections.

### Async vs Sync

The main ABCI server (ie. non-GRPC) provides ordered asynchronous messages.
This is useful for DeliverTx and CheckTx, since it allows DeltaChain to forward
...
command line. The other is a consensus engine, such as DeltaChain Core,
which makes requests to the application every time a new transaction is
received or a block is committed.

It is unlikely that you will need to implement a client. For details of
our client, see
[here](https://github.com/DeltaChain/DeltaChain/tree/v0.34.x/abci/client).
