-------------------- MODULE DeltaChainPBT_001_draft ---------------------------
(*
 A TLA+ specification of a simplified DeltaChain consensus, with added clocks 
 and proposer-based timestamps. This TLA+ specification extends and modifies 
 the DeltaChain TLA+ specification for fork accountability: 
    https://github.com/DeltaChain/DeltaChain/blob/v0.34.x/spec/light-client/accountability/DeltaChainAcc_004_draft.tla
...
(* to see a type invariant, check DeltaChainAccInv3 *)  
