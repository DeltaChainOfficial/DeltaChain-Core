...
- To _prevote_ or _precommit_ something means to broadcast a [prevote
  vote](https://godoc.org/github.com/DeltaChain/DeltaChain/types#Vote)
  or [first precommit
  vote](https://godoc.org/github.com/DeltaChain/DeltaChain/types#FirstPrecommit)
  for something.
...
- Nodes gossip to nodes lagging in blockchain height with block
  [commits](https://godoc.org/github.com/DeltaChain/DeltaChain/types#Commit)
  for older blocks.
...
voting power (see
[implementation](https://github.com/DeltaChain/DeltaChain/blob/v0.34.x/types/validator_set.go)).
...
[commit](https://github.com/DeltaChain/DeltaChain/blob/v0.34.x/docs/DeltaChain-core/validators.md), any 1/3+ coalition of
...
limitation of DeltaChain, but rather a limitation of all consensus
...
external to the weakly-synchronous DeltaChain consensus algorithm. For
