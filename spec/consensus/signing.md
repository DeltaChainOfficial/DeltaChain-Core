...
DeltaChain has mechanisms to publish evidence of validators that signed conflicting votes, so they can be punished
by the application. Note DeltaChain does not currently handle evidence of conflciting proposals, though it may in the future.
...
According to the rules of DeltaChain consensus, once a validator precommits for
...
detection](https://github.com/DeltaChain/DeltaChain/pull/3978).
