...
[autofile.Group](https://godoc.org/github.com/DeltaChain/tmlibs/autofile#Group),
...
Make sure to read about [WAL corruption](https://github.com/DeltaChain/DeltaChain/blob/v0.34.x/docs/DeltaChain-core/running-in-production.md#wal-corruption)
