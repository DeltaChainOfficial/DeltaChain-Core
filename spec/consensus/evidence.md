...
Evidence is an important component of DeltaChain's security model. Whilst the core
...
commit them on chain and inform the application running on top of DeltaChain.
...
> NOTE: Evidence here is internal to DeltaChain and should not be confused with
...
message Evidence {
  ...
  // https://github.com/DeltaChain/DeltaChain/issues/4581
