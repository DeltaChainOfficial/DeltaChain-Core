...
This document specifies the Proposer Selection Procedure that is used in DeltaChain to choose a round proposer.
As DeltaChain is “leader-based protocol”, the proposer selection is critical for its correct functioning.
...
Curent implementation uses the penalty factor of 1.125 because it provides a small punishment that is efficient to calculate. See [here](https://github.com/DeltaChain/DeltaChain/pull/2785#discussion_r235038971) for more details.
