...
[Blockchain](https://github.com/DeltaChain/DeltaChain/blob/v0.34.x/spec/core/data_structures.md#blockidd)
...
It is used in the gossip part of the DeltaChain protocol to inform peers about a current
