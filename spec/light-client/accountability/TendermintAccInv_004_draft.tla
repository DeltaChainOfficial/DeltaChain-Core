------------------- MODULE DeltaChainAccInv_004_draft --------------------------
(*
 An inductive invariant for DeltaChainAcc3, which capture the forked
...
EXTENDS DeltaChainAcc_004_draft
...
(* The standard condition of the DeltaChain security model *)
