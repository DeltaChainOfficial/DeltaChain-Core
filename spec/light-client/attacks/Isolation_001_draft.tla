 ...
 *
 * https://github.com/DeltaChain/spec/blob/master/rust-spec/lightclient/attacks/isolate-attackers_001_draft.md
 *
 ...
 *
 *  - DeltaChain security model is violated
    ...
    /\ \E referenceRound, evidenceRound \in Int:
      ...
      /\ LET reference == blockchain[CONFLICT_HEIGHT]
        ...
        ELSE
          ...
          \* Accountability of DeltaChainAcc3.tla
          /\ state' := "Amnesia"
