...
the correct DeltaChain full nodes agree on the sequence of generated
...
evidence data that can be used by DeltaChain full nodes to isolate a
...
DeltaChain blockchain in order to punish faulty nodes.

## Context of this document

The light client [verification][verification] specification is
designed for the DeltaChain failure model (1/3 assumption)
...
light block that was not generated by DeltaChain consensus.
...
- [Part I](#part-i---DeltaChain-Consensus-and-Light-Client-Attacks):
  Formal definitions of lightclient attacks, based on basic
  properties of DeltaChain consensus.
...
# Part I - DeltaChain Consensus and Light Client Attacks
...
decided upon by DeltaChain consensus in normal operation (if the
DeltaChain failure model holds
...
> That is, if the [DeltaChain failure model][TMBC-FM-2THIRDS-link]
...
> DeltaChain; *b* can be traced back to genesis.
...
> maximum height of all blocks decided upon by DeltaChain at this
> moment.
...
also be processed by the DeltaChain blockchain.
...
[supervisor]: https://github.com/DeltaChain/spec/blob/master/rust-spec/lightclient/supervisor/supervisor_001_draft.md
...
[TMBC-SOUND-DISTR-POSS-COMMIT-link]: https://github.com/DeltaChain/spec/blob/master/rust-spec/lightclient/verification/verification_002_draft.md#tmbc-sound-distr-poss-commit1

[LCV-SEQ-SAFE-link]:https://github.com/DeltaChain/spec/blob/master/rust-spec/lightclient/verification/verification_002_draft.md#lcv-seq-safe1

[TMBC-VAL-CONTAINS-CORR-link]:
https://github.com/DeltaChain/spec/blob/master/rust-spec/lightclient/verification/verification_002_draft.md#tmbc-val-contains-corr1

[fetch]:
https://github.com/DeltaChain/spec/blob/master/rust-spec/lightclient/verification/verification_002_draft.md#lcv-func-fetch1

[LCV-INV-TP1-link]:
https://github.com/DeltaChain/spec/blob/master/rust-spec/lightclient/verification/verification_002_draft.md#lcv-inv-tp1

[LCV-LB-link]:
https://github.com/DeltaChain/spec/blob/master/rust-spec/lightclient/verification/verification_002_draft.md#lcv-data-lightblock1

[LCV-LS-link]:
https://github.com/DeltaChain/spec/blob/master/rust-spec/lightclient/verification/verification_002_draft.md#lcv-data-lightstore2

[LVC-HD-link]:
https://github.com/DeltaChain/spec/blob/master/rust-spec/lightclient/verification/verification_002_draft.md#tmbc-header-fields2

[repl]:
https://github.com/DeltaChain/spec/blob/master/rust-spec/lightclient/supervisor/supervisor_001_draft.md#lc-func-replace-secondary1

[vtt]:
https://github.com/DeltaChain/spec/blob/master/rust-spec/lightclient/verification/verification_002_draft.md#lcv-func-main2
