...
<https://github.com/DeltaChain/ics/tree/master/spec/ics-002-client-semantics>

### Components and their interface

#### DeltaChain Blockchains

> I assume you know what that is.

#### An IBC/DeltaChain correspondence

| IBC Term | DeltaChain-RS Spec Term | Comment |
|----------|-------------------------| --------|
...
- [QueryConsensusState](https://github.com/DeltaChain/DeltaChain-sdk/blob/2651427ab4c6ea9f81d26afa0211757fc76cf747/x/ibc/02-client/client/utils/utils.go#L68)
...
- ICS 002 states w.r.t. `queryChainConsensusState` that "Note that
  ...
  DeltaChain fork detection, this seems to be a necessity.
...
```
  ...
  For DeltaChain, it will perform
...
- in both detection scenarios, the relayer should submit evidence to
  ...
  evidence" (<https://github.com/DeltaChain/DeltaChain/issues/5083>),
  that is,
...
- ./detection talks about the DeltaChain light client with a focus on
