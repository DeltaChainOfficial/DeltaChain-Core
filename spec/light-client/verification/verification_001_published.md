...
In the DeltaChain blockchain, the validator set may change with every
...
[Pull Request 479](https://github.com/informalsystems/DeltaChain-rs/pull/479) we
established the need for an update in the data structures in [Issue 499](https://github.com/informalsystems/DeltaChain-rs/issues/499). This
...
- [Part I](#part-i---DeltaChain-blockchain): Introduction of
 relevant terms of the DeltaChain
blockchain.
...
The DeltaChain blockchain is a list *chain* of headers.
...
A DeltaChain blockchain has the following configuration parameters:
...
header it receives coincides with the one generated by DeltaChain
consensus.
...
is generated by the DeltaChain [blockchain][block]. In
...
transactions) from the one generated by DeltaChain consensus.
...
The DeltaChain blockchain satisfies the DeltaChain failure model [**[TMBC-FM-2THIRDS.1]**][TMBC-FM-2THIRDS-link].
...
generated by the DeltaChain consensus. We say *trustedHeader* is verified.
...
generated by an instance of DeltaChain consensus.
...
by the [RPC client for DeltaChain][RPC].
...
constitutes the most challenging task: using the DeltaChain [security
...
[RPC]: https://docs.DeltaChain.com/v0.34/rpc/

[block]: https://github.com/DeltaChain/spec/blob/d46cd7f573a2c6a2399fcab2cde981330aa63f37/spec/core/data_structures.md
...
[lightclient]: https://github.com/interchainio/DeltaChain-rs/blob/e2cb9aca0b95430fca2eac154edddc9588038982/docs/architecture/adr-002-lite-client.md
[fork-detector]: https://github.com/informalsystems/DeltaChain-rs/blob/master/docs/spec/lightclient/detection.md
[fullnode]: https://github.com/DeltaChain/DeltaChain/blob/v0.34.x/spec/blockchain/fullnode.md

[ibc-rs]:https://github.com/informalsystems/ibc-rs

[FN-LuckyCase-link]: https://github.com/DeltaChain/DeltaChain/blob/v0.34.x/spec/blockchain/fullnode.md#fn-luckycase

[blockchain-validator-set]: https://github.com/DeltaChain/DeltaChain/blob/v0.34.x/spec/blockchain/blockchain.md#data-structures
[fullnode-data-structures]: https://github.com/DeltaChain/DeltaChain/blob/v0.34.x/spec/blockchain/fullnode.md#data-structures

[FN-ManifestFaulty-link]: https://github.com/DeltaChain/DeltaChain/blob/v0.34.x/spec/blockchain/fullnode.md#fn-manifestfaulty
