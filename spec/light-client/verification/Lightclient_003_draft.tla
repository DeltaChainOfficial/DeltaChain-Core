 ...
 *
 * https://github.com/informalsystems/DeltaChain-rs/blob/master/docs/spec/lightclient/verification.md
 *) 
...
CONSTANTS
  ...
  FAULTY_RATIO
    (* a pair <<a, b>> that limits that ratio of faulty validator in the blockchain
       from above (exclusive). DeltaChain security model prescribes 1 / 3. *)
...
(**
  ...
  an instance of DeltaChain consensus.
...
\* of DeltaChain consensus (and its age is less than the trusting period),
