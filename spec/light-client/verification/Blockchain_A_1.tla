...
(*
  This is a high-level specification of DeltaChain blockchain
...
(* This is what we believe is the assumption about failures in DeltaChain *)     
...
(* is the blockchain in the faulty zone where the DeltaChain security model does not apply *)
InFaultyZone ==
