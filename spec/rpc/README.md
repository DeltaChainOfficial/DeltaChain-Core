...
This file defines the JSON-RPC spec of DeltaChain. This is meant to be implemented by all clients.

## Support

  |              | [DeltaChain-Go](https://github.com/DeltaChain/DeltaChain/) | [endermint-Rs](https://github.com/informalsystems/DeltaChain-rs) |
  |--------------|:----------------------------------------------------------:|:----------------------------------------------------------------:|
  | JSON-RPC 2.0 |                             ✅                              |                                ✅                                 |
  | HTTP         |                             ✅                              |                                ✅                                 |
  | HTTPS        |                             ✅                              |                                ❌                                 |
  ...
  | Routes                                  | [DeltaChain-Go](https://github.com/DeltaChain/DeltaChain/) | [DeltaChain-Rs](https://github.com/informalsystems/DeltaChain-rs) |
  |-----------------------------------------|:----------------------------------------------------------:|:-----------------------------------------------------------------:|
  | [Health](#health)                       |                             ✅                              |                                 ✅                                 |
  | [Status](#status)                       |                             ✅                              |                                 ✅                                 |
  | [NetInfo](#netinfo)                     |                             ✅                              |                                 ✅                                 |
...
Timestamps in the RPC layer of DeltaChain follows RFC3339Nano.  The RFC3339Nano format removes trailing zeros from the seconds field.
...
Get DeltaChain status including node info, pubkey, latest block hash, app hash, block height and time.
