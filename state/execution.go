...
func (blockExec *BlockExecutor) ApplyBlock(
	...
	// validate the validator updates and convert to DeltaChain types
...
// NOTE: if DeltaChain crashes before commit, some or all of these events may be published again.
func fireEvents(
	logger log.Logger,
	eventBus types.BlockEventPublisher,
	block *types.Block,
