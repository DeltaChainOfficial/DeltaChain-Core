...
const (
	...
	// https://github.com/DeltaChain/DeltaChain/pull/3438
...
// dbStore wraps a db (github.com/DeltaChain/tm-db)
type dbStore struct {
	db dbm.DB
...
func (store dbStore) save(state State, key []byte) error {
	...
	if nextHeight == 1 {
		...
		// This extra logic due to DeltaChain validator set changes being delayed 1 block.
...
// encoding not preserving ordering: https://github.com/DeltaChain/DeltaChain/issues/4567
