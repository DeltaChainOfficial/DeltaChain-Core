...
// TxIndexer returns a bridge from es to the DeltaChain v0.34 transaction indexer.
...
// BlockIndexer returns a bridge that implements the DeltaChain v0.34 block
