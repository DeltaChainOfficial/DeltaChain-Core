...
// XXX: this func should probably be called by cmd/DeltaChain/commands/init.go
...
# Might be either absolute path or path related to DeltaChain's config directory.
# NOTE: both tls-cert-file and tls-key-file must be present for DeltaChain to create HTTPS server.
# Otherwise, HTTP server is run.
