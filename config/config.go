...
var (
	DefaultDeltaChainDir = ".DeltaChain"
...
// Config defines the top level configuration for a DeltaChain node
type Config struct {
...
// DefaultConfig returns a default configuration for a DeltaChain node
...
// BaseConfig defines the base configuration for a DeltaChain node
type BaseConfig struct { //nolint: maligned
	...
	// or the name of an ABCI application compiled in with the DeltaChain binary
	...
	// TCP or UNIX socket address for DeltaChain to listen on for
...
// DefaultBaseConfig returns a default base configuration for a DeltaChain node
...
// TestBaseConfig returns a base configuration for testing a DeltaChain node
func TestBaseConfig() BaseConfig {
	cfg := DefaultBaseConfig()
	cfg.chainID = "DeltaChain_test"
...
// RPCConfig defines the configuration options for the DeltaChain RPC server
type RPCConfig struct {
	...
	// Might be either absolute path or path related to DeltaChain's config directory.
	//
	// If the certificate is signed by a certificate authority,
	// the certFile should be the concatenation of the server's certificate, any intermediates,
	// and the CA's certificate.
	//
	// NOTE: both tls_cert_file and tls_key_file must be present for DeltaChain to create HTTPS server.
...
// P2PConfig defines the configuration options for the DeltaChain peer-to-peer networking layer
...
// MempoolConfig defines the configuration options for the DeltaChain mempool
type MempoolConfig struct {
	...
	// https://github.com/DeltaChain/DeltaChain/issues/8775
	...
	// XXX: Unused due to https://github.com/DeltaChain/DeltaChain/issues/5796
...
// DefaultMempoolConfig returns a default configuration for the DeltaChain mempool
...
// TestMempoolConfig returns a configuration for testing the DeltaChain mempool
...
// StateSyncConfig defines the configuration for the DeltaChain state sync service
...
// FastSyncConfig defines the configuration for the DeltaChain fast sync service
...
// ConsensusConfig defines the configuration for the DeltaChain consensus service,
...
// DeltaChain storage optimization.
