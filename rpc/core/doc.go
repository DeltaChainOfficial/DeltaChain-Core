/*
Package core defines the DeltaChain RPC endpoints.

DeltaChain ships with its own JSONRPC library -
https://github.com/DeltaChain/DeltaChain/tree/v0.34.x/rpc/jsonrpc.
