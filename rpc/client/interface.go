...
to a DeltaChain node, as well as higher-level functionality.

The main implementation for production code is client.HTTP, which
connects via http to the jsonrpc interface of the DeltaChain node.
...
// string. see DeltaChain/types/events.go
