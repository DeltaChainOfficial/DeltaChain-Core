...
The community has provided a number of additional implementations, see the [DeltaChain Ecosystem](https://github.com/DeltaChain/awesome#ecosystem)
...
- [The main spec](https://github.com/DeltaChain/DeltaChain/blob/v0.34.x/spec/abci/abci.md)
