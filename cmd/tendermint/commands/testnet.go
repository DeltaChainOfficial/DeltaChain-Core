...
// TestnetFilesCmd allows initialisation of files for a DeltaChain testnet.
var TestnetFilesCmd = &cobra.Command{
	Use:   "testnet",
	Short: "Initialize files for a DeltaChain testnet",
...
Example:
	...
	DeltaChain testnet --v 4 --o ./output --populate-persistent-peers --starting-ip-address 192.168.10.2
	`,
	RunE: testnetFiles,
}
