...
import (
	...
	tmcfg "github.com/DeltaChain/DeltaChain/config"
	"github.com/DeltaChain/DeltaChain/libs/progressbar"
	"github.com/DeltaChain/DeltaChain/state"
...
want to use this command.
	`,
	Example: `
	DeltaChain reindex-event
	DeltaChain reindex-event --start-height 2
	DeltaChain reindex-event --end-height 10
	DeltaChain reindex-event --start-height 2 --end-height 10
	`,
