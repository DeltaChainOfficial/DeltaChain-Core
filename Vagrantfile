...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    echo 'cd go/src/github.com/DeltaChain/DeltaChain' >> /home/vagrant/.bash_profile

    mkdir -p /home/vagrant/go/bin
    mkdir -p /home/vagrant/go/src/github.com/DeltaChain
    ln -s /vagrant /home/vagrant/go/src/github.com/DeltaChain/DeltaChain
    ...
    su - vagrant -c 'cd /home/vagrant/go/src/github.com/DeltaChain/DeltaChain && make tools'
  SHELL
end
